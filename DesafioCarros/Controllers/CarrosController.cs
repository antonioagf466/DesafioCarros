...
namespace DesafioCarros.Controllers
{
    public class CarrosController : Controller
    {
        ...
        public CarrosController(DesafioCarrosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Carro != null ? 
                          ...
                          Problem("Entity set 'DesafioCarrosContext.Carro'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'DesafioCarrosContext.Carro'  is null.");
            }
            var carro = await _context.Carro.FindAsync(id);
            if (carro != null)
            {
